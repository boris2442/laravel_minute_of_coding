...
<div class="py-6">
    ...
    <div class="flex items-center justify-between my-4">
        <a class="py-2 px-4 bg-green-600 hover:bg-green-700 text-white rounded" href={{ route('blog.create') }}>create
            un
            article</a>
    ...
    <ul class="flex flex-wrap gap-3 items-center">
        ...
        <li class='border border-gray-300 p-2 my-2 max-w-[400px]'>
            <img src="{{ asset($article->image) }}" alt="{{ $article->title }}"
                class=' object-cover h-[300px] mb-4 max-h-[200px] w-full hover:scale-105' />
