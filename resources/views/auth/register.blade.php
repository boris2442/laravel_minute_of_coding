...
<div class="mb-4">
    ...
    <input type="email" id="email" class=" mt-1 p-3 block w-full border-gray-300 shadow-md " name='email'>
    @error('email')
    <p class='bg-red-100 text-red-500 p-3 font-bold'>{{$message}}</p>
    @enderror
</div>
<div class="mb-4">
    ...
    <input type="password" id="password" class=" mt-1 p-3 block w-full border-gray-300 shadow-md " name='password'>
    @error('password')
    <p class='bg-red-100 text-red-500 p-3 font-bold'>{{$message}}</p>
    @enderror
</div>
<div class="mb-4">
    ...
    <input type="password" id="password" class=" mt-1 p-3 block w-full border-gray-300 shadow-md " name='password_confirmation'>
    @error('password_confirmation')
    <p class='bg-red-100 text-red-500 p-3 font-bold'>{{$message}}</p>
    @enderror
</div>
<button type='submit' class='text-white rounded-md w-full py-2 px-4 bg-gray-800 hover:bg-gray-900' >S'inscrire</button>
